...
namespace HappyShop.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                cart.Prices = GetPriceBasedOnQuantity(cart);
                ShoppingCartVM.OrderHeader.OrderTotal += (cart.Prices * cart.Count);
            }
        ...
        private double GetPriceBasedOnQuantity(ShoppingCart shoppingCart)
        {
                ...
                return shoppingCart.Product.Prices;
...
u.Id == userId);
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser.Name;
            ShoppingCartVM.OrderHeader.PhoneNumber =
            ShoppingCartVM.OrderHeader.ApplicationUser.PhoneNumber;
        ...
        [HttpPost]
        [ActionName("Summary")] // Perform same action as summary
...
includeProperties: "Product");
            ...
            if (applicationUser.CompanyId.GetValueOrDefault() == 0)
            {
                //it is a regular customer account and you need to capture
                ...
                foreach (var item in ShoppingCartVM.ShoppingCartList)
                {
                    ...
                    SessionLineItemPriceDataOptions
                        {
                            UnitAmount = (long)(item.Prices * 100),
                            //$20.50 => 2050
                            Currency = "usd",
                            ProductData = new
...
ShoppingCartVM.OrderHeader.Id
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            OrderHeader orderHeader = _unitOfWork.OrderHeader.Get(u => u.Id ==
id, includeProperties: "ApplicationUser");
