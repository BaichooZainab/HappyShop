...
namespace happyshop.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            OrderVM = new()
            {
                OrderHeader = _unitOfWork.OrderHeader.Get(u => u.Id == orderId, includeProperties:
            "ApplicationUser"),
        ...
        public IActionResult Details_PAY_NOW()
        {
            ...
            foreach (var item in OrderVM.OrderDetail)
            {
                var sessionLineItem = new SessionLineItemOptions
                {
                    ...
                    {
                        UnitAmount = (long)(item.Prices * 100), // $20.50 => 2050
                        Currency = "usd",
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId)
        {
            ...
            if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment)
            {
                ...
                {
                    _unitOfWork.OrderHeader.UpdateStripePaymentID(orderHeaderId, session.Id,
                    session.PaymentIntentId);
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "pending":
                    objOrderHeaders = objOrderHeaders.Where(u => u.PaymentStatus ==
                    SD.PaymentStatusDelayedPayment); // company places order
                    break;
                case "inprocess":
