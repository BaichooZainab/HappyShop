    ...
    public partial class seeddb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 2, 21, 48, 37, 727, DateTimeKind.Local).AddTicks(5675), 1, "Guitars" },
                    { 2, new DateTime(2024, 2, 2, 21, 48, 37, 727, DateTimeKind.Local).AddTicks(5692), 2, "Drums" },
                    { 3, new DateTime(2024, 2, 2, 21, 48, 37, 727, DateTimeKind.Local).AddTicks(5695), 3, "Piano" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Brandname", "CategoryId", "Description", "ImageUrl", "Prices", "Productname", "Quantities" },
                values: new object[,]
                {
